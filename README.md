...
Gmail Chrome extension + Express backend that drafts context-aware replies via a 5-stage Gemini multi-agent pipeline (classify → strategy → context → generate → safety review).

`Node.js` `Chrome Extension` `Gemini API`

[![View Project](https://img.shields.io/badge/VIEW_PROJECT-F59E0B?style=for-the-badge)](https://github.com/vigneshsiva11/Ai-Reply-Generator)
